# 1 "..\\HardWare\\IIC\\myiic.c"
# 1 "..\\HardWare\\IIC\\myiic.h"
# 1 "..\\System\\sys\\sys.h"
# 1 "..\\User\\stm32f4xx.h"
...
# 2 "..\\HardWare\\IIC\\myiic.c"
# 1 "..\\System\\delay\\delay.h"
# 4 "..\\System\\delay\\delay.h"
...
{			
  ...
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &GPIO_InitStructure);
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=1;
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(9<<2))))=1;
}

void IIC_Start(void)
{
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->MODER&=~(3<<(9*2));((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->MODER|=1<<9*2;};     
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(9<<2))))=1;	  	  
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=1;
	delay_us(4);
 	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(9<<2))))=0;
	delay_us(4);
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=0;
}	  
...
{
	u8 ucErrTime=0;
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->MODER&=~(3<<(9*2));((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))->MODER|=0<<9*2;};      
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(9<<2))))=1;delay_us(1);	   
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=1;delay_us(1);	 
	while(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+16) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+16) &0xFFFFF)<<5)+(9<<2)))))
	{
		ucErrTime++;
		if(ucErrTime>250)
		{
...
{                        
    ...
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=0;
    for(t=0;t<8;t++)
    {              
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(9<<2))))=(txd&0x80)>>7;
        txd<<=1; 	  
		delay_us(2);   
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=1;
		delay_us(2); 
...
u8 IIC_Read_Byte(unsigned char ack)
{
    ...
    for(i=0;i<8;i++ )
	{
		...
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+20) &0xFFFFF)<<5)+(8<<2))))=1;
        receive<<=1;
        if(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+16) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x00020000) + 0x0400)+16) &0xFFFFF)<<5)+(9<<2)))))receive++;   
		delay_us(1); 
    }					 
    if (!ack)
        IIC_NAck();
