...
{	 
    ...
    GPIO_PinAFConfig(SPI1_Port,SPI2_Pinsourse_SCK,GPIO_AF_SPI2); //PB3复用为 SPI1
    GPIO_PinAFConfig(SPI1_Port,SPI2_Pinsourse_MISO,GPIO_AF_SPI2); //PB4复用为 SPI1
    GPIO_PinAFConfig(SPI1_Port,SPI2_Pinsourse_MOSI,GPIO_AF_SPI2); //PB5复用为 SPI1
...
u8 SPI_ReadWriteByte(SPI_TypeDef*SPI,u8 Data)
{		 			 
